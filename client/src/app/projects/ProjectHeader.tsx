...
import { Clock, Filter, Grid3x3, PlusSquare, Share2, Table } from 'lucide-react';
  ...
  return (
    <div className='px-4 xl:px-6'>
      <ModalNewProject
        ...
        <div className="pb-6 pt-6 lg:pb-4 lg:pt-8 z-30 dark:text-white">
             <Header name="Development mode"  
                    buttonComponent={
        ...
        {/* Tabs */}
        <div className="flex flex-wrap-reverse gap-2 border-y border-x-gray-200 pb-[8px] pt-2 dark:border-stroke-dark md:items-center">
