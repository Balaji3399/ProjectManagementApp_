    ...
    <div className='flex items-center justify-between bg-white px-4 py-3 dark:bg-black dark:px-4 dark:py-3'>
        <div className="flex items-center gap-8">
            ...
            <div className="relative flex h-min w-[200px]">
                ...
                <input 
                    className='w-full rounded border-none bg-gray-100 p-2 pl-8 placeholder-gray-500 focus:border-transparent 
        ...
        <div className='flex items-center'>
            ...
            {/* <div className="ml-2 mr-5 hidden min-h min-h-[2em] w-[0.1rem] bg-gray-200 md:inline-block"></div> */}
        </div>
    </div>
  )
}
